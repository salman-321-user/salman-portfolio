...
const Skills = () => {
  ...
  const skills = [
    ...
    { 
      name: 'Graphic Design', 
      icon: '/assets/graphic_designing.png', 
      level: 80, 
    ...
    { 
      ...
      icon: '/assets/jetpack_compose.png', 
      level: 70, 
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
                  ...
                  {[0, 25, 50, 75, 100].map((point) => (
                    <div
                      ...
                      className={`w-1 h-1 rounded-full transition-all duration-300 ${
                        skill.level >= point ? 'bg-purple-500' : 'bg-gray-300 dark:bg-gray-500'
        ...
        <div className={`mt-12 max-w-4xl mx-auto transition-all duration-500 transform ${
          activeSkill ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-4 scale-95'
        }`}>
          {activeSkill && (
